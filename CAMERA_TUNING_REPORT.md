...
- Năm cảnh ngoại thất chạy một chiều theo thứ tự Hero → Performance → Aerodynamics → Rear Signature → Precision. Precision chuyển tiếp sang góc sau-trái thay vì quay ngược về góc đầu, nên năm điểm dừng phủ các phía khác nhau của xe.
- Waypoint desktop lần lượt là `[-2.50, 3.20, 8.50]`, `[4.50, 3.50, 5.80]`, `[8.50, 2.80, -7.00]`, `[-3.15, 1.00, -6.55]`; compact dùng `[-1.15, 1.90, 8.00]`, `[10.40, 5.10, 7.30]`, `[8.00, 3.50, -10.50]`, `[-4.20, 1.30, -8.00]`.
