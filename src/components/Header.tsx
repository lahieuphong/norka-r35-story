...
export function Header({ exploreActive }: Props) {
  return (
    <header className={`site-header${exploreActive ? ' is-muted' : ''}`} inert={exploreActive}>
      ...
      <nav aria-label="Story sections"><a href="#aerodynamics">Design</a><a href="#performance">Power</a><a href="#explore">Explore</a></nav>
      <span className="header-index" aria-hidden="true">01—05</span>
    </header>
  );
}
