...
const desktopInteriorTransition: InteriorTransitionSet = {
  ...
  cockpit: { position: [0.38, 1.03, -0.25], target: [0.35, 0.78, 0.72], fov: 62 },
};
...
const compactInteriorTransition: InteriorTransitionSet = {
  ...
  cockpit: { position: [0.38, 1.03, -0.35], target: [0.34, 0.84, 0.65], fov: 82 },
};
...
const shortLandscapeInteriorTransition: InteriorTransitionSet = {
  ...
  cockpit: { position: [0.38, 1.02, -0.25], target: [0.35, 0.79, 0.72], fov: 65 },
};
