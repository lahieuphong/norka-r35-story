export const STORY_SHOT_ORDER = ['hero', 'aerodynamics', 'performance', 'rear-signature', 'precision', 'interior', 'steering', 'instruments', 'front-seats', 'rear-seats', 'rear-seat-detail', 'explore'] as const;
...
export const desktopShots: CameraShotSet = {
  ...
  'rear-signature': { position: [-4.1, 1.6, -6], target: [-1.45, 0.52, -1.7], fov: 33 },
...
export const mobileShots: CameraShotSet = {
  ...
  'rear-signature': { position: [-8.3, 2.4, -10.8], target: [-0.5, 0.25, -1.35], fov: 52 },
