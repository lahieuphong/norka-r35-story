  ...
  return (
    <div className={`experience${exploreActive ? ' experience--explore' : ''}`}>
      ...
      <main className="story-root" data-story-root inert={exploreActive}>
        <StorySection id="explore" index="01" eyebrow="Interactive" heading="3D Experience" body="Inspect the vehicle from every angle." ctaLabel="Explore the car" onCta={enterExplore} ctaDisabled={!modelReady || phase !== 'story'} ctaButtonRef={exploreButtonRef} />
